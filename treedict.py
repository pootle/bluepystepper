#!/usr/bin/env python3
"""
This module extends OrderedDict to support multiple levels. In effect a tree of dict like objects navigable
...
To achieve this, __getitem__ is redefined to allow filesystem like navigation using '..' and '/'. This does mean
